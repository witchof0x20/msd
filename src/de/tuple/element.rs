use crate::de::{parse::Values, r#enum, error, Error, Result};
...
impl<'a, 'b, 'de> serde::Deserializer<'de> for Deserializer<'a, 'b> {
    ...
    where
        V: Visitor<'de>,
    {
        Err(Error::new(error::Kind::CannotDeserializeAsSelfDescribing, self.values.current_position()))
    }
...
mod tests {
    ...
    fn any() {
        ...
        assert_err_eq!(Any::deserialize(deserializer), Error::new(error::Kind::CannotDeserializeAsSelfDescribing, Position::new(1, 2)));
    }
    ...
    fn ignored_any() {
        ...
        assert_err_eq!(IgnoredAny::deserialize(deserializer), Error::new(error::Kind::CannotDeserializeAsSelfDescribing, Position::new(1, 2)));
    }
}
